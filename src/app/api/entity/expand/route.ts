...
/**
 * Thin proxy to the OCULIX Intelligence Layer (oculix-intel).
 *
 * In Docker: fetches from http://oculix-intel:4000/resolve
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[OCULIX] Intel proxy error:', e instanceof Error ? e.message : e);
    return NextResponse.json(
