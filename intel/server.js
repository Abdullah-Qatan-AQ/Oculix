/**
 * OCULIX Intelligence Layer — oculix-intel
 *
...
const WIKIDATA_UA = 'OCULIX-Intel/1.0 (https://oculix.example; ontology engine)';
...
app.get('/resolve', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      links: result.links,
      entity: { type, id },
      source: 'OCULIX Intelligence Layer',
...
async function boot() {
  console.log('[INTEL] OCULIX Intelligence Layer starting...');
  await loadSanctions();
