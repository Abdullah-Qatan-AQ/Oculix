#!/bin/bash
# =========================================================
#  OCULIX — Deploy Cycle Script
#  Git → SSH → Docker Rebuild → Live
# =========================================================
#
#  Usage (from your local oculix project directory):
...
echo -e "${CYAN}╔══════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║     OCULIX DEPLOYMENT CYCLE              ║${NC}"
...
COMMIT_MSG="${1:-deploy: update oculix production $(date '+%Y-%m-%d %H:%M')}"
