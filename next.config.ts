    ...
    return [
      {
        source: '/(.*)',
        headers: [
          { key: 'Content-Security-Policy', value: "default-src 'self' 'unsafe-inline' 'unsafe-eval' https: wss: data: blob:; base-uri 'self'; frame-ancestors 'self'; object-src 'none'; form-action 'self';" },
